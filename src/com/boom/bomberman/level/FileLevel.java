...
import com.boom.bomberman.entities.LayeredEntity;
import com.boom.bomberman.entities.mob.Player;
import com.boom.bomberman.entities.mob.enemy.*;
import com.boom.bomberman.entities.mob.enemy.Vip;
import com.boom.bomberman.entities.tile.GrassTile;
import com.boom.bomberman.entities.tile.PortalTile;
import com.boom.bomberman.entities.tile.WallTile;
import com.boom.bomberman.entities.tile.destroyable.BrickTile;
import com.boom.bomberman.entities.tile.powerup.PowerupBombs;
import com.boom.bomberman.entities.tile.powerup.PowerupFlames;
import com.boom.bomberman.entities.tile.powerup.PowerupSpeed;
	...
	public void addLevelEntity(char c, int x, int y) {
		...
		switch(c) { // TODO: minimize this method
			...
			case '6':
				...
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
			case '7':
				_board.addMob( new Vip(Coordinates.tileToPixel(x), Coordinates.tileToPixel(y) + Game.TILES_SIZE, _board));
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
			default:
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
				break;

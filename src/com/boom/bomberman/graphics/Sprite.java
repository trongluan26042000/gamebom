package com.boom.bomberman.graphics;
...
public class Sprite {
	...
	//Vip
	public static Sprite vip_left1 = new Sprite(16, 12, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite vip_left2 = new Sprite(16, 12, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite vip_left3 = new Sprite(16, 12, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite vip_right1 = new Sprite(16, 13, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite vip_right2 = new Sprite(16, 13, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite vip_right3 = new Sprite(16, 13, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite vip_dead = new Sprite(16, 13, 8, SpriteSheet.tiles, 16, 16);

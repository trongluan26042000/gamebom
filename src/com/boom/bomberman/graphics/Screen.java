...
public class Screen {
	...
	public void drawEndGame(Graphics g, int points, String code) {
		...
		Font font = new Font("Jokerman", Font.PLAIN, 25 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.red);
		drawCenteredString("GAME OVER", getRealWidth(), getRealHeight(), g);
		
		font = new Font("SHOWCARD GOTHIC", Font.PLAIN, 10 * Game.SCALE);
		g.setFont(font);
	...
	public void drawChangeLevel(Graphics g, int level) {
		...
		Font font = new Font("Ink Free", Font.PLAIN, 30 * Game.SCALE);
		g.setFont(font);
	...
	public void drawPaused(Graphics g) {
		Font font = new Font("Algerian", Font.PLAIN, 30 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.blue);
